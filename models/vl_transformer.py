...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, src,
        ...
        if self.norm is not None:  # default is none
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward_post(self,
        ...
        src = self.norm1(src)
        # without use src_key_padding_mask
    ...
    def forward(self, src,
        ...
        # The Swin-Transformer v2 paper states that placing the norm layer before the operation can cause issues,
        # and by default, the norm layer is placed after.
